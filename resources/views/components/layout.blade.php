...
<body
    class="h-full bg-neutral-bg dark:bg-[#0b0f19] font-sans antialiased text-secondary dark:text-slate-400 overflow-hidden">
    ...
    <div class="flex h-full w-full overflow-hidden" id="app-wrapper">
        ...
        <div id="sidebar-overlay" onclick="closeMobileSidebar()" class="fixed inset-0 bg-black/50 z-20 hidden lg:hidden"
            aria-hidden="true">
        </div>
        ...
        <aside id="sidebar" aria-label="Sidebar Navigation"
            ...
            <nav class="flex-1 px-2 py-3 overflow-y-auto overflow-x-hidden" aria-label="Main navigation">
                ...
                <button class="btn btn-light sidebar-toggle d-none" id="sidebarToggle">
        ...
        <div class="flex-1 flex flex-col h-full min-w-0 overflow-hidden">
            ...
            <header id="top-navbar"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span
                        class="font-bold text-sm tracking-wider uppercase text-primary dark:text-slate-200 hidden sm:inline-block">OmniCore
                        Suite</span>
                </div>
                ...
                <div class="flex items-center gap-2 md:gap-3 shrink-0">
                    ...
                    <div class="relative hidden md:block" id="global-search-wrapper">
                        <span
                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-secondary/40 dark:text-slate-600">
                        ...
                        <div id="search-autocomplete-menu"
                            ...
                            <div
                                class="px-3 py-1 text-xs font-semibold text-secondary/50 uppercase tracking-wider border-b border-border-subtle dark:border-slate-800">
                                Suggestions
                            </div>
                            <div class="divide-y divide-border-subtle dark:divide-slate-800"
                    ...
                    <button type="button" id="theme-toggle-btn" aria-label="Toggle Theme"
                        ...
                        <svg class="w-5 h-5 hidden dark:block text-amber-400" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="relative" id="notification-dropdown-wrapper">
                        <button type="button" aria-label="Notifications" id="notification-btn"
                            ...
                            <span
                                class="absolute -top-1 -right-1 flex items-center justify-center min-w-[16px] h-4 px-1 rounded-full bg-danger text-white text-[10px] font-bold border border-panel-bg dark:border-slate-900 leading-none">3</span>
                        </button>
                        {{-- Dropdown Menu --}}
                        <div id="notification-dropdown-menu"
                            ...
                            <div
                                class="px-4 py-2 font-semibold text-primary dark:text-slate-200 border-b border-border-subtle dark:border-slate-800">
                                Notifications (3)
                            </div>
                            <div class="max-h-64 overflow-y-auto divide-y divide-border-subtle dark:divide-slate-800">
                                <div class="px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer"
                                    onclick="switchPanel('inventory-products')">
                                    <div class="flex items-start gap-2">
                                        <span class="w-2 h-2 rounded-full bg-danger mt-1.5 shrink-0"></span>
                                        <div>
                                            <p class="font-medium text-primary dark:text-slate-200 m-0 leading-normal">
                                                System Alert</p>
                                            <p
                                                class="text-secondary dark:text-slate-400 m-0 text-xs mt-0.5 leading-normal">
                                                3 products have fallen below their safety threshold.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer"
                                    ...
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p
                                                class="text-secondary dark:text-slate-400 m-0 text-xs mt-0.5 leading-normal">
                                                Database auto-backup completed successfully.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer"
                                    ...
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p
                                                class="text-secondary dark:text-slate-400 m-0 text-xs mt-0.5 leading-normal">
                                                Maintenance window scheduled for Dec 2026.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="px-4 py-2 text-center border-t border-border-subtle dark:border-slate-800">
                                <a href="#"
                                    class="text-primary dark:text-blue-400 hover:underline font-medium text-xs">Mark
                                    all as read</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative" id="profile-dropdown-wrapper">
                        <div class="flex items-center gap-2 p-1 rounded cursor-pointer
                            ...
                            <div
                                class="w-8 h-8 rounded-full bg-primary text-white
                                    font-bold text-sm flex items-center justify-center shrink-0">
                                SA
                            </div>
                            <div class="hidden sm:block text-left">
                                <span
                                    class="block text-sm font-semibold text-primary dark:text-slate-100 leading-none">
                                    Sajjad Admin
                                </span>
                        ...
                        <div id="profile-dropdown-menu"
                            ...
                            <a href="#"
                                class="block px-4 py-2 text-primary dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50"
                                onclick="switchPanel('admin')">My Profile</a>
                            <a href="#"
                                class="block px-4 py-2 text-primary dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50"
                                onclick="switchPanel('docs')">Settings</a>
                            <div class="border-t border-border-subtle dark:border-slate-800 my-1"></div>
                            <a href="#"
                                class="block px-4 py-2 text-danger hover:bg-red-50 dark:hover:bg-red-950/20"
                                onclick="alert('Logged out successfully.')">Logout</a>
                        </div>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto flex flex-col h-full" id="main-content">
                ...
                <div
                    class="sticky top-0 z-10 shrink-0 bg-panel-bg/95 dark:bg-slate-900/95 backdrop-blur-md px-4 md:px-6 py-4 border-b border-border-subtle dark:border-slate-800 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 shadow-sm select-none">
                    <div class="min-w-0">
                        {{-- Breadcrumbs (render only if more than 0 levels) --}}
                        @if (count($breadcrumbs) > 0)
                            <nav class="flex items-center gap-1.5 text-sm text-secondary dark:text-slate-400 mb-1.5 select-none"
                                aria-label="Breadcrumb" id="breadcrumb-container">
                                <a href="#"
                                    onclick="switchPanel('admin', document.querySelector('[data-panel=admin]'))"
                                    class="hover:text-primary dark:hover:text-blue-400 transition-colors font-medium">Home</a>
                                @foreach ($breadcrumbs as $index => $bc)
                                    <span class="text-secondary/40 dark:text-slate-600">/</span>
                                    @if ($index === count($breadcrumbs) - 1)
                                        <span class="font-semibold text-primary dark:text-blue-400"
                                            id="breadcrumb-current">{{ $bc }}</span>
                                    @else
                        ...
                        @endif
                        <h1
                            class="text-2xl font-semibold text-primary dark:text-slate-100 m-0 leading-tight tracking-tight">
                            {{ $title }}
                        </h1>
                        @if ($subtitle)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function applyDesktopState() {
                if (isLg()) {
                    if (desktopCollapsed) {
                        ...
                        if (brand) {
                            brand.classList.add('opacity-0', 'w-0', 'ml-0');
                            brand.classList.remove('opacity-100');
                        }
                        if (footerMeta) {
                            footerMeta.classList.add('opacity-0');
                            footerMeta.classList.remove('opacity-100');
                        }
                        navLabels.forEach(l => l.classList.add('hidden'));

                        // Hide submenus when sidebar is collapsed
                        document.querySelectorAll('.sidebar-label-container').forEach(c => c.classList.add(
                            'hidden'));
                        ...
                        if (brand) {
                            brand.classList.remove('opacity-0', 'w-0', 'ml-0');
                            brand.classList.add('opacity-100');
                        }
                        if (footerMeta) {
                            footerMeta.classList.remove('opacity-0');
                            footerMeta.classList.add('opacity-100');
                        }
                        ...
                        document.querySelectorAll('.sidebar-label-container').forEach(c => {
                            const subId = c.id;
                            const arrow = document.getElementById('submenu-arrow-' + subId.replace(
                                'submenu-', ''));
            ...
            function showSuggestions(query) {
                ...
                if (filtered.length === 0) {
                    searchList.innerHTML =
                        `<div class="px-4 py-2.5 text-xs text-secondary/50">No panels found</div>`;
                } else {
            ...
            window.handleSearchSelect = function(id, name) {
                ...
                const trigger = document.querySelector(`[data-panel="${id}"]`) || document.querySelector(
                    `[data-panel="${cleanId}"]`);
